...
- (instancetype)initWithFrame:(CGRect)frame type:(FCChartViewType)type dataSource:(id<FCChartViewDataSource>)dataSource suspendSection:(NSInteger)suspendSection{
    if (self = [super initWithFrame:frame]) {
        ...
        _suspendSection = suspendSection;
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section < self.suspendSection) {
        ...
        cell = [self.dataSource collectionViewCell:cell collectionViewType:FCChartCollectionViewTypeSuspendSection cellForItemAtIndexPath:indexPath cellForView:self];
        return cell;
    }
    if (indexPath.row <self.suspendRow) {
        ...
        cell = [self.dataSource collectionViewCell:cell collectionViewType:FCChartCollectionViewTypeSuspendRow cellForItemAtIndexPath:indexP cellForView:self] ;
        return cell;
    }
    ...
    cell = [self.dataSource collectionViewCell:cell collectionViewType:FCChartCollectionViewTypeMain cellForItemAtIndexPath:indexP cellForView:self];
    return cell;
}
