...
- (void)configureProperty
{
    ...
    _buttonDefaultTitleColor = [UIColor colorWithRed:19/255. green:110/255. blue:251/255. alpha:1.0];
...
- (void)addAction:(TYAlertAction *)action
{
    ...
    [button setTitleColor:_buttonDefaultTitleColor forState:UIControlStateNormal];
